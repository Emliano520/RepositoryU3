...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(set);// print, logra imprimir los datos debido a la interfaz
        boolean existeVerde = set.contains("Verde");// verificar si existe x objeto dentro del set
        set.remove("Azul");// remover por objeto (por el tipo de dato)
        int tam = set.size();// tamaño del set de datos

        for (String data : set) {// recorrido manual
